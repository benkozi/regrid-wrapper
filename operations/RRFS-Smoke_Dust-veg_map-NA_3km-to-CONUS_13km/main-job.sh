#!/usr/bin/env bash
#
#SBATCH --job-name=RRFS-Smoke_Dust-veg_map-NA_3km-to-CONUS_13km
#SBATCH --account=epic
#SBATCH --qos=batch
...
#SBATCH --ntasks=720 # Total tasks should be nodes * tasks-per-node
...
LOGDIR=${DIR}/logs/RRFS-Smoke_Dust-veg_map-NA_3km-to-CONUS_13km
...
mkdir -p ${LOGDIR}
cd ${LOGDIR}
mpirun -np 720 python ${DIR}/operations/RRFS-Smoke_Dust-veg_map-NA_3km-to-CONUS_13km/main.py
